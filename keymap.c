...
[_LOWER] = {
  ...
  {KC_PSCR, KC_TILD,    _______,  _______,      _______,  _______, _______, _______, _______, _______, _______, KC_PIPE},
  {KC_TAB,  _______,    _______,  _______,      _______,  _______, _______, _______, _______, _______, _______, KC_QUOT },
  {_______, LCTL(KC_X), _______,  LCTL(KC_C),LCTL(KC_V),  _______, KC_HOME, KC_END,  _______, _______, _______, _______},
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |      |ISO # |ISO / |      |      |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = {
  ...
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, KC_NUHS, KC_NUBS, _______, _______, _______},
